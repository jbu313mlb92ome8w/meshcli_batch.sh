...
#####
```
This code block is in the [example/cmd_rep_bas.txt](/blob/main/examples/cmd_rep_bas.txt) and [blanks/cmd_pre.txt](/blob/main/blanks/cmd_pre.txt) commented out. You can see the prupose of it listed in the commented oout portion. I use this to change the coding rate to 8 on my base repeater while leaving my mobile repeater at the US default of 5.\
